...
class BoardWidget extends Pad {
    ...
    public synchronized void paintComponent(Graphics2D g) {
        ...
        g.setColor(NEUTRAL);
        g.fill(new Rectangle(0, 0, _side, _side));
    ...
    private void displaySpots(Graphics2D g, int r, int c) {
        ...
        Square tmp = _board.get(r, c);
        if (tmp.getSide() == WHITE) {
            g.setColor(NEUTRAL);
        } else if (tmp.getSide() == RED) {
            g.setColor(RED_TINT);
        } else if (tmp.getSide() == BLUE) {
            g.setColor(BLUE_TINT);
        }
        g.fillRect(x, y, SQUARE_SIZE, SQUARE_SIZE);
        switch (_board.get(r, c).getSpots()) {
        case 2: spot(g, x + SPOT_DIM + 5, y + SPOT_DIM + 5);
                spot(g, x + SPOT_DIM * 2 + 5, y + SPOT_DIM * 2 + 5);
                break;
        case 3: spot(g, x + SPOT_DIM + 5, y + SPOT_DIM + 5);
                spot(g, x + SPOT_DIM * 2 + 5, y + SPOT_DIM * 2 + 5);
                spot(g, x + SPOT_DIM * 3 + 5, y + SPOT_DIM * 3 + 5);
                break;
        case 4: spot(g, x + SPOT_DIM + 5, y + SPOT_DIM + 5);
                spot(g, x + SPOT_DIM * 2 + 5, y + SPOT_DIM * 2 + 5);
                spot(g, x + SPOT_DIM * 3 + 5, y + SPOT_DIM * 3 + 5);
                spot(g, x + SPOT_DIM * 4 + 5, y + SPOT_DIM * 4 + 5);
                break;
        default: spot(g, x + SPOT_DIM + 5, y + SPOT_DIM + 5);
        }
    }
    ...
    /** Return the current player side. */
